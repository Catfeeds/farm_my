...
/**
 * PHPExcel_Shared_Escher_Dgforeach_Spgrforeach_Spforeach
 *
 ...
 */
class PHPExcel_Shared_Escher_Dgforeach_Spgrforeach_Spforeach
{
    /**
    ...
    /**
     * Get the parent Shape Group foreach
     *
     * @return PHPExcel_Shared_Escher_Dgforeach_Spgrforeach
     */
    ...
    /**
     * Set an option for the Shape Group foreach
     *
    ...
    /**
     * Get an option for the Shape Group foreach
     *
     * @param int $property The number specifies the option
     * @return mixed
     */
    ...
    /**
     * Get the nesting level of this spforeach. This is the number of spgrforeachs between this spforeach and
     * the dgforeach. A value of 1 = immediately within first spgrforeach
     * Higher nesting level occurs if and only if spforeach is part of a shape group
     *
    ...
    public function getNestingLevel()
    {
        ...
        while ($parent instanceof PHPExcel_Shared_Escher_Dgforeach_Spgrforeach) {
            ++$nestingLevel;
